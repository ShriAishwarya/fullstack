...
const LazyChart=lazy(()=>import("./Components/Pages/Admin/Chart"));
...
const LazyDash=lazy(()=>import("./Components/Pages/Admin/AdminDashboard"));
const LazyBoats=lazy(()=>import("./Components/Pages/Admin/Boats"));
// const LazyOver=lazy(()=>import("./Components/Pages/Admin/AdminOverview"));
const LazyUL=lazy(()=>import("./Components/Pages/Admin/UserLists"));
const LazyBL=lazy(()=>import( "./Components/Pages/Admin/BookingList"));
                        ...
                        element:<Suspense fallback={<Spinner />}><LazyDash/></Suspense>
                          },
                          {
                            ...
                            element:<Suspense fallback={<Spinner />}><LazyChart/></Suspense>
                              ...
                              {
                                path:'/boats',
                                element:<Suspense fallback={<Spinner />}><LazyBoats/></Suspense>
                                  },
                                  {
                                    path:'/userlist',
                                    element:<Suspense fallback={<Spinner />}><LazyUL/></Suspense>
                                      },
                                      {
                                        path:'/bookinglist',
                                        element:<Suspense fallback={<Spinner />}><LazyBL/></Suspense>
                                          },
                      {
                        path:'/admin/profile',
